...
class StudyBoardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_study_board, container, false)
        ...
        view.findViewById<ImageView>(R.id.writeButton).setOnClickListener {
            val bundle = Bundle().apply {
                putString("tableName", DatabaseHelper.TABLE_STUDY) // StudyNotes 테이블
                putInt("previousFragmentId", R.id.studyBoardFragment) // 현재(스터디팟 게시판) Fragment ID 전달
            }
